...
|---|---|---|---|---|
| 学習データ（873発話、TTS 18話者） | 820/873 (93.9%) | 818/873 (93.6%) | 809/873 (92.7%) | 859/873 (98.4%) |
...
外部話者で「から」(kara) が他の語（部下 buka 等）に置換される。TTS学習データでは正解。
...
全学習データがTTS合成音声のみ。速度変換データ拡張でピッチ・話速の変動は模擬できるが、異なる声質・録音環境は模擬できない。
